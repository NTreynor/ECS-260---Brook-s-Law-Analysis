...
def main():
    ...
    testUrl = ["https://github.com/runelite/runelite", "https://github.com/cosmos/cosmos-sdk", "https://github.com/github/gemoji", "https://github.com/leereilly/swot"]
    for x in testUrl:
...
def evaluate_metrics(repo, interval_list):
    ...
    for i in range(0, len(interval_list)): 
        ...
        daily_churn, daily_commits = calc_14_day_metrics(repo, pre_end_date)
